        ...
        >
          ...
          <div className="p-6 space-y-4">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={handleLogin}
              className="w-full bg-gradient-to-r from-brand-600 to-blue-600 text-white py-3 px-6 rounded-lg font-medium hover:from-brand-700 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 transition-all duration-200 shadow-brand-lg flex items-center justify-center"
            >
