          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
              ...
              <button
                ...
                className={`shrink-0 self-center focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-gray-700 inline-flex items-center w-10 h-5 p-[2px] rounded-full transition-colors duration-200 ease-in-out ${
                  redirectToSumUp ? 'bg-purple-600 justify-end' : 'bg-gray-500 justify-start'
                }`}
                title={redirectToSumUp ? 'Zapnuto' : 'Vypnuto'}
              >
                <span className="w-4 h-4 rounded-full bg-white shadow-sm transition-transform duration-200 ease-in-out" />
              </button>
            </div>
