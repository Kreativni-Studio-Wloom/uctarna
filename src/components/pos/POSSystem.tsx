      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 md:gap-4 lg:gap-6">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            {isReturnMode && (
              <div className="bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-400 pl-2 md:pl-3 pr-1.5 py-1 rounded-lg text-xs md:text-sm font-medium flex items-center">
                ...
                <button
                  ...
                  className="ml-1 w-4 h-4 flex items-center justify-center rounded hover:bg-red-200 dark:hover:bg-red-900/40 transition-colors flex-shrink-0"
